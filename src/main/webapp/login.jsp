...
<body>
                ...
                <div class="d-flex justify-content-center" style="padding-top: 10%;">
                    <div class="col-sm-3 align-middle" style="text-align: center;">
                        <h3 class="textcss"><b>Bug Tracker</b></h3>
                            ...
                            <br />
                            <a href="registration" style="color: #0C5F0C; text-decoration: underline; font-size: 12pt;">Register User</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="html/assets/plugins/jquery/dist/jquery.min.js"></script>
